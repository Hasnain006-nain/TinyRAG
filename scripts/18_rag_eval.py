...
logger = get_logger("RAGEvaluation")
...
def load_completed_ids():
    ...
    try:
        ...
        logger.warning(
            "Could not load existing results: %s",
            exc
        )
...
def main():
    ...
    print()
    print("=" * 65)
    print("TinyRAG FULL RAG EVALUATION")
    print("=" * 65)
    print(
        f"Model:        {MODEL_NAME}"
    )
    ...
    if len(retrieval) != NUM_QUESTIONS:
    ...
    if len(completed_ids) == NUM_QUESTIONS:

        print()
        print(
            "All questions are already complete."
        )
    ...
    print()
    print("=" * 65)
    print("FULL TINYRAG EVALUATION COMPLETE")
    print("=" * 65)
